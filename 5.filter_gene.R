...
counts <- read.csv("transcript_abundance_quantification_table.csv",header=T,row.names=1)
...
write.csv(data.frame(GeneID=rownames(gene_filter1),gene_filter1),"transcript_abundance_quantification_table_filter.csv",row.names=F)
